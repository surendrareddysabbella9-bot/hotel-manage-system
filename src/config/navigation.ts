...
export const adminNavItems: NavItem[] = [
  ...
  { label: "Orders", href: ROUTES.admin.orders, icon: "ShoppingBag", badge: 18 },
  { label: "Menu", href: ROUTES.admin.menu, icon: "UtensilsCrossed" },
  { label: "Inventory", href: ROUTES.admin.inventory, icon: "Package", badge: 2 },
...
export const staffNavItems: NavItem[] = [
  ...
  { label: "Orders", href: ROUTES.staff.orders, icon: "ClipboardList", badge: 5 },
...
export const customerNavItems: NavItem[] = [
  ...
  { label: "Reservation", href: ROUTES.customer.reservation, icon: "Calendar" },
